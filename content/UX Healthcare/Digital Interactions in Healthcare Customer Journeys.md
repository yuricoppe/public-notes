...
[==User Research==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-user-research-1)
- [==User Research==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-user-research-1)
- [==Results==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-results-2)
- [==Physical and Digital Interactions Are Interplayed==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-physical-and-digital-interactions-are-interplayed-3)
- [==Pain Points==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-pain-points-4)
- [==Patients' Perceptions of Digital Healthcare Interactions==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-patients-perceptions-of-digital-healthcare-interactions-5)
- [==Conclusion==](https://www.nngroup.com/articles/healthcare-customer-journeys/#toc-conclusion-6)
...
[![](https://media.nngroup.com/media/editor/2023/02/11/number-of-interactions-by-type.jpeg)](https://media.nngroup.com/media/editor/2023/02/11/number-of-interactions-by-type.jpeg)
==_The most common interactions reported by our diary participants were related to appointments._==
...
==Participants noted that performing simpler tasks on their smartphones helped them to complete interactions quickly.==
[![](https://media.nngroup.com/media/editor/2023/02/11/digital-interactions-performed-on-smartphones.jpeg)](https://media.nngroup.com/media/editor/2023/02/11/digital-interactions-performed-on-smartphones.jpeg)
==_The most common online interactions performed on smartphones by our diary participants were scheduling and communication. (Phone calls were excluded from this chart.)_==
==**The second most used devices were computers**== ==(desktops or laptops), which consumers often chose for== ==**complex or time-consuming interactions**====. 14 of the 93 reported interactions took place on a computer.==
...
==Those who started interactions on their smartphones sometimes moved to computers for more complicated tasks such as filling out intake forms. The lack of proper mobile support for these tasks was what led these consumers to choose the computer's functionality over the smartphone's convenience.==
[![](https://media.nngroup.com/media/editor/2023/02/11/digital-interactions-performed-on-computers.jpeg)](https://media.nngroup.com/media/editor/2023/02/11/digital-interactions-performed-on-computers.jpeg)
==_Most participants reported using their computers to fill out intake paperwork and to check in to virtual appointments._==

### ==Patient Portals and Phone Calls: The Most Used Channels for Healthcare Interactions==

==Overall, participants used digital channels much more frequently than traditional channels (such as phone call or in person) to interact with their healthcare providers (21 traditional vs. 72 digital interactions).==
[![](https://media.nngroup.com/media/editor/2023/02/11/number-of-interactions-by-channel.jpeg)](https://media.nngroup.com/media/editor/2023/02/11/number-of-interactions-by-channel.jpeg)
==_Patient portals, phone calls, and physical locations were the most used channels for healthcare interactions._==
...
==Because patient-portal interactions are asynchronous, it is easier for both parties to interact at their own convenience. Recipients are notified about communications via patient portals, and messages can be accessed at any time through the portal, with no expiration date.==
[![](https://media.nngroup.com/media/editor/2023/02/11/mychart-patient-portal.png)](https://media.nngroup.com/media/editor/2023/02/11/mychart-patient-portal.png)
==_One participant used a patient portal, MyChart, to send messages to his provider. He also received updates and reminders about upcoming appointments in the portal._==
...
==One common point of friction in any customer journey occurs when users transition from in-person to digital touchpoints or vice versa. This friction usually happens when the digital and in-person interactions are out of sync and the transitions are not== [==seamless==](https://www.nngroup.com/articles/seamless-cross-channel/)==.==
...
==In some journeys, this was the case. For example, one study participant needed to take her daughter to the emergency room. She called the hospital and was advised to schedule a walk-in time slot through the provider’s mobile app. After scheduling the appointment, she was prompted to fill out paperwork, add insurance information, and complete the entire check-in process before arriving. Later, she received a notification that she could bring her daughter in to be seen. The participant found the mobile scheduling and check-in experience incredibly useful; these interactions made a typically stressful experience much more comfortable and low stress, as she and her daughter were able to wait in the comfort of their own home.==
[![](https://media.nngroup.com/media/editor/2023/02/11/hospital-mobile-app-booking-and-virtual-check-in.jpeg)](https://media.nngroup.com/media/editor/2023/02/11/hospital-mobile-app-booking-and-virtual-check-in.jpeg)
==_A study participant used a hospital’s mobile app to schedule an appointment for the emergency room. She was prompted to check in virtually and fill in all necessary information in advance to streamline her experience._==

## ==Pain Points==

==UX professionals aspire to create easy and seamless end-to-end customer-journey experiences. While a few study participants had seamless journeys, many did face== [==pain points==](https://www.nngroup.com/articles/pain-points/) ==while interacting with healthcare providers to receive care. Nearly half of the user journeys we observed included at least one pain point, with some experiencing multiple in the same journey. Pain points happened more frequently in digital interactions than in in-person ones. Some of the pain points encountered by users included:==
- [==**Findability**==](https://www.nngroup.com/videos/findability-vs-discoverability/) [==of information or features==](https://www.nngroup.com/videos/findability-vs-discoverability/)==. When using portals, several participants had difficulty finding information or features that existed. For example, a participant was unable to locate where lab results were posted within a patient portal.==
...
==Users appreciated the ability to== ==**interact with care providers via digital channels**====, citing that these online options provided increased efficiency, flexibility, and== [==autonomy in how they approach and receive care==](https://www.nngroup.com/articles/autonomy-relatedness-competence/)==.==
...
==Simply providing digital communication options or providing access to an online portal is not enough. These digital channels and touchpoints must be thoughtfully integrated into the broader experience, which often still includes in-person interactions. To do this, healthcare systems must adopt a== [==journey-centric approach==](https://www.nngroup.com/articles/customer-journeys-omnichannel/) ==to patient care, by identifying common customer goals and working to understand the comprehensive experience users have as they move across touchpoints to achieve these goals. Each health system and the care experience it provides will differ, so it’s necessary to== [==conduct research==](https://www.nngroup.com/videos/ethnography-ux/) ==in order to understand users' needs and the pain points they encounter along the way. However, based on our study, we can suggest several general guidelines that would be applicable to most healthcare journeys.==
