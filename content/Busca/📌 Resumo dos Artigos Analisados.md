...
### 2. **[Search UX Best Practices (Nulab)](https://nulab.com/learn/design-and-ux/search-ux-best-practices/)**
...
### 3. **[Best Practices for Search Results (UX Planet)](https://uxplanet.org/best-practices-for-search-results-1bbed9d7a311)**

- **Principais Pontos**:
    - **Hierarquia visual**: Destaque resultados relevantes (ex.: promoções).
    - **Paginação clara**: Evite scroll infinito para comparação.
    - **Filtros contextuais**: Por categoria, preço, localização, etc.
    - **Performance**: Carregamento rápido é essencial.

---

### 4. **[Search Results Page Design (Medium)](https://medium.com/@halolab/search-results-page-design-ui-ux-best-practices-f2157eea8226)**
...
### 5. **[Search Box UX Examples (Coveo)](https://www.coveo.com/blog/search-box-ux-examples/)**
...
### 6. **[Search: Visible and Simple (NNGroup)](https://www.nngroup.com/articles/search-visible-and-simple/)**
