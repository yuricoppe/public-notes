...
Esta seção orienta sobre o uso de fotografia em nosso produto, definindo o estilo, o propósito e as melhores práticas para garantir que as imagens contribuam positivamente para a experiência do usuário e reforcem a identidade da marca.
...
5.  **Cores Consistentes com a Marca:**
...
-   **Formato:**
    ...
    *   **PNG:** Usar apenas se a transparência for necessária e não for uma fotografia (ícones, ilustrações).
-   **Compressão:**
...
-   Uso excessivo de filtros ou edições que distorçam a realidade.
