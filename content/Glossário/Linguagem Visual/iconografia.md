...
- Definir um estilo visual único para todos os ícones (ex: contornado, preenchido, duas cores, etc.).
...
- **Navegação:** Usados em menus, barras de navegação (ex: Home, Perfil, Configurações).
...
### Ilustrações
- Gráficos mais detalhados usados para enriquecer a experiência, em telas de onboarding, estados vazios, ou para comunicar conceitos complexos de forma visual.
- Definir o estilo das ilustrações para manter a consistência com o restante do Design System.
