...
2.  **Navegação Secundária/Local (Sub-navigation/Sidebars):**
    ...
    *   **Comportamento Responsivo:** Sidebars podem ser recolhíveis ou transformadas em menus [[Glossário/Elementos/form_controls|dropdown]]/off-canvas em telas menores.
...
4.  **[[Glossário/Componentes/footer|Rodapé]] Global (Global Footer):**
    *   **Propósito:** [[Glossário/Elementos/links|Links]] de utilidade (termos de serviço, política de privacidade), informações de copyright, links para redes sociais.
...
(Incluir [[Glossário/Entregáveis/wireframe|wireframes]] ou [[Glossário/Entregáveis/mockup|mockups]] de baixo/médio fidelidade demonstrando a aplicação da estrutura de layout em diferentes tipos de página e em diferentes breakpoints.)
