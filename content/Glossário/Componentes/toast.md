...
-   **(Opcional) [[Glossário/Elementos/botoes|Botão]] de Ação:** Um [[Glossário/Elementos/links|link]] ou botão para uma ação contextual (ex: "Desfazer" após excluir um item, "Ver Detalhes").
