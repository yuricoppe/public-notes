...
-   Feedback em protótipos ou designs.
-   Anotações em documentos ou tarefas colaborativas.

## Funcionalidades Essenciais

-   **Exibição de Comentários:**
    *   Lista de comentários, geralmente em ordem cronológica ou por relevância.
    *   Nome/avatar do autor do comentário.
    *   Conteúdo do comentário.
    *   Timestamp (data e hora) da postagem.
-   **Formulário para Novo Comentário:**
    *   Campo de texto (textarea) para o usuário digitar o comentário.
    *   Botão para submeter/publicar o comentário.
...
-   **Clareza e Legibilidade:** Comentários devem ser fáceis de ler, com bom espaçamento e tipografia clara.
...
-   **Links em Comentários:** Decidir se links são permitidos e como são tratados (ex: `rel="nofollow"`, abrir em nova aba).
