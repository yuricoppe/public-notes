...
-   Feedback em [[Entregáveis/prototype|protótipos]] ou designs.
-   Anotações em documentos ou tarefas colaborativas.

## Funcionalidades Essenciais

-   **Exibição de Comentários:**
    *   [[Elementos/listas|Lista]] de comentários, geralmente em ordem cronológica ou por relevância.
    *   Nome/avatar do autor do comentário.
    *   Conteúdo do comentário.
    *   Timestamp (data e hora) da postagem.
-   **[[Padrões/form_structure|Formulário]] para Novo Comentário:**
    *   [[Elementos/form_controls|Campo de texto]] (textarea) para o usuário digitar o comentário.
    *   [[Elementos/botoes|Botão]] para submeter/publicar o comentário.
...
-   **Clareza e Legibilidade:** Comentários devem ser fáceis de ler, com bom [[Linguagem Visual/espacamento|espaçamento]] e [[Linguagem Visual/tipografia|tipografia]] clara.
...
-   **Acessibilidade (a11y):**
    *   O [[Padrões/form_structure|formulário]] de comentário deve ser acessível, com labels para os campos e [[Elementos/botoes|botões]] operáveis por teclado.
    *   Comentários devem ser estruturados de forma semântica (ex: cada comentário como um `<article>` ou `<li>` dentro de uma [[Elementos/listas|lista]]).
    *   Ações como responder, curtir, denunciar devem ser [[Elementos/botoes|botões]] acessíveis.
-   **Notificações (Opcional):** Notificar usuários sobre respostas aos seus comentários.
-   **[[Elementos/links|Links]] em Comentários:** Decidir se [[Elementos/links|links]] são permitidos e como são tratados (ex: `rel="nofollow"`, abrir em nova aba).
...
-   **[[Padrões/authentication|Login]] Social para Comentar.**

## Estrutura Comum

-   **Título da Seção** (ex: "Comentários", "Discussão").
-   **(Opcional) Resumo/Contador de Comentários.**
-   **[[Padrões/form_structure|Formulário]] de Novo Comentário.**
-   **[[Elementos/listas|Lista]] de Comentários:**
...
-   **(Opcional) Paginação ou [[Elementos/botoes|Botão]] "Carregar Mais".**

## O Que Evitar

-   [[Padrões/form_structure|Formulários]] de comentário complexos ou que exigem muita informação.
...
-   Não permitir que usuários anônimos (se desejado) participem facilmente (ex: exigindo [[Padrões/authentication|login]] para tudo). 