...
-   **Dropdowns/Selects:** Para selecionar uma ou múltiplas opções de uma [[Glossário/Elementos/listas|lista]], especialmente útil quando há muitas opções.
...
-   **[[Glossário/Elementos/form_controls|Campos de Texto]]/Busca:** Para filtrar por termos de pesquisa dentro de um atributo (ex: buscar nome do produto).
-   **[[Glossário/Elementos/botoes|Botões]] de [[Glossário/Elementos/interruptor|Toggle]]/Chips:** Para aplicar ou remover rapidamente filtros de categorias comuns.
-   **Seletores de Data/Período (Date Pickers):** Para filtrar por data ou intervalo de datas.
-   **Seletores de [[Glossário/Linguagem Visual/cor|Cor]] ([[Glossário/Linguagem Visual/cor|Color]] Swatches):** Para filtrar por [[Glossário/Linguagem Visual/cor|cor]].
...
-   **[[Glossário/Componentes/dialog|Modal]]/Drawer:** Filtros são apresentados em um [[Glossário/Componentes/dialog|dialog]] ou drawer, especialmente em telas mobile para economizar espaço.
...
-   **Feedback Imediato:** O conjunto de dados deve ser atualizado (ou mostrar um indicador de carregamento) assim que um filtro é aplicado ou alterado.
    *   Alguns sistemas usam um [[Glossário/Elementos/botoes|botão]] "Aplicar Filtros" para permitir múltiplas seleções antes de atualizar, especialmente se a atualização for custosa.
...
-   **Acessibilidade (a11y):**
    *   Todos os controles de filtro ([[Glossário/Elementos/form_controls|checkboxes]], selects, etc.) devem ser acessíveis por teclado e ter rótulos claros.
    *   Se os filtros estão em uma seção, ela deve ter um título apropriado (ex: `<h2>Filtros</h2>` ou `<fieldset><[[Glossário/Componentes/legend|legend]]>Filtros</[[Glossário/Componentes/legend|legend]]>...</fieldset>`).
