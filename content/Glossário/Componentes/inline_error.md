...
-   **(Opcional) [[Glossário/Linguagem Visual/iconografia|Ícone]] de Erro:** Um pequeno ícone (ex: "X", triângulo de aviso) para reforçar visualmente que é uma mensagem de erro.
-   **Posicionamento:** Diretamente abaixo ou ao lado do campo ou elemento ao qual se refere.
-   **Estilo Visual:** [[Glossário/Linguagem Visual/cor|Cor]] de texto distintiva (geralmente vermelho) e, às vezes, uma cor de fundo sutil para destacar a mensagem.
