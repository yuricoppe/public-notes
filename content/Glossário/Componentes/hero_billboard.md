...
-   **(Opcional) [[Glossário/Elementos/imagem|Imagem]] ou Ilustração em Primeiro Plano:** Sobreposta ou ao lado do texto, complementando a mensagem.
...
-   **CTA Proeminente:** O [[Glossário/Elementos/botoes|botão]] de Call to Action deve ser fácil de identificar e ter um texto que incentive o clique.
-   **Hierarquia Visual:** O título deve ser o elemento mais dominante, seguido pelo subtítulo e pelo CTA.
-   **Qualidade Visual:** [[Glossário/Elementos/imagem|Imagens]] e vídeos devem ser de alta qualidade e otimizados para a web.
-   **Legibilidade do Texto:** Garantir que o texto sobreposto a [[Glossário/Elementos/imagem|imagens]] ou vídeos tenha contraste suficiente para ser facilmente legível.
    *   Usar overlays, sombras de texto ou escolher [[Glossário/Elementos/imagem|imagens]] com áreas mais neutras para o texto.
-   **Responsividade:** O layout do Hero deve se adaptar perfeitamente a todos os tamanhos de tela, desde desktops grandes até dispositivos móveis. Isso pode envolver:
    *   Redimensionamento de fontes e [[Glossário/Elementos/imagem|imagens]].
    *   Recorte de [[Glossário/Elementos/imagem|imagens]] de fundo de forma inteligente (`background-position`, `object-fit`).
    *   Empilhamento de elementos.
    *   Servir [[Glossário/Elementos/imagem|imagens]] de tamanhos diferentes para diferentes viewports.
-   **Performance:** [[Glossário/Elementos/imagem|Imagens]] e vídeos grandes podem impactar o tempo de carregamento da página (LCP - Largest Contentful Paint). Otimizar esses assets é crucial.
-   **Acessibilidade (a11y):**
    *   O título principal deve ser, idealmente, o `<h1>` da página.
    *   Todo o texto deve ter contraste adequado com o fundo.
    *   [[Glossário/Elementos/imagem|Imagens]] de fundo devem ter alternativas ou serem consideradas decorativas se o texto transmitir toda a informação essencial.
    *   CTAs ([[Glossário/Elementos/botoes|botões]]) devem ser acessíveis por teclado e ter rótulos claros.

## Variações

-   **Hero com [[Glossário/Elementos/imagem|Imagem]] de Tela Cheia.**
...
-   [[Glossário/Elementos/imagem|Imagens]] de baixa qualidade ou irrelevantes.
