...
- **[[Glossário/Linguagem Visual/iconografia|Ícone]]:** Comumente usa um [[Glossário/Linguagem Visual/iconografia|ícone]] de seta para cima (`↑`).
...
- **Acessibilidade:** Deve ser focável e operável via teclado. O [[Glossário/Linguagem Visual/iconografia|ícone]] deve ter um texto alternativo adequado (ex: `aria-label="Voltar ao topo da página"`).

## Variações

- **[[Glossário/Elementos/botoes|Botão]] "Voltar ao Topo" Padrão:**
  - Descrição: [[Glossário/Elementos/botoes|Botão]] flutuante que aparece no canto inferior direito após rolagem.
  - Estilo: [Formato (circular, quadrado com cantos arredondados), [[Glossário/Linguagem Visual/cor|cor]], sombra, [[Glossário/Linguagem Visual/iconografia|ícone]]]
  ...
  - Status: A definir
  - [[Glossário/Elementos/links|Link]] para o Figma: [[[Glossário/Elementos/links|Link]] para [[Glossário/Elementos/botoes|Botão]] Voltar ao Topo no Figma]
