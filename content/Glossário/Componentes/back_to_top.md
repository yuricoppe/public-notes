...
O botão "Voltar ao Topo" é um controle de navegação que permite ao usuário retornar rapidamente ao início de uma página longa após rolar para baixo. Ele aparece contextualmente quando o usuário rola uma certa distância da página.
...
- **Ícone:** Comumente usa um ícone de seta para cima (`↑`).
