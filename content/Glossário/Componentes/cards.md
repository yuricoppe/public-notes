...
Cards são contêineres de interface que agrupam informações e ações relacionadas sobre um único tópico ou item. Eles são uma forma popular de apresentar conteúdo de maneira organizada e escaneável, especialmente em layouts de grade ou listas.
...
-   **Mídia (Opcional):** Imagem, vídeo, ilustração no topo ou lateral do card.
-   **Cabeçalho/Título (Opcional):** Título principal do card.
...
-   **Ações (Opcional):** Botões, links ou ícones que permitem ao usuário interagir com o conteúdo do card (ex: "Saiba Mais", "Adicionar ao Carrinho", "Editar").
-   **Ícones (Opcional):** Para metadados ou ações.
-   **Avatar/Thumbnail (Opcional):** Pequena imagem representando um usuário ou item.
-   **Tags/Badges (Opcional):** Para categorizar ou destacar status.
...
-   **Hierarquia Visual Clara:** Usar tipografia, espaçamento e ênfase para guiar o olho do usuário através das informações do card.
