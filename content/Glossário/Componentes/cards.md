...
-   **Conteúdo Principal (Opcional):** Texto mais detalhado, [[Glossário/Elementos/listas|listas]], metadados.
...
-   **[[Glossário/Linguagem Visual/iconografia|Ícones]] (Opcional):** Para metadados ou ações.
-   **Avatar/Thumbnail (Opcional):** Pequena [[Glossário/Elementos/imagem|imagem]] representando um usuário ou item.
...
-   **[[Glossário/Linguagem Visual/espacamento|Espaçamento]]:** Usar padding adequado dentro do card e margens entre os cards para evitar um layout congestionado.
...
-   **Acessibilidade (a11y):**
    ...
    *   Se o card inteiro for um [[Glossário/Elementos/links|link]], envolva seu conteúdo em uma tag `<a>` ou use JavaScript para adicionar o comportamento de clique e role `button` com `aria-label` adequado.
    *   Todos os elementos interativos dentro do card ([[Glossário/Elementos/botoes|botões]], [[Glossário/Elementos/links|links]]) devem ser acessíveis por teclado e ter rótulos claros.
    *   [[Glossário/Elementos/imagem|Imagens]] devem ter `alt` text.

## Variações de Estilo e Layout

-   **Card Padrão:** Mídia no topo, seguida de título, descrição e ações.
-   **Card com Mídia Lateral:** [[Glossário/Elementos/imagem|Imagem]] à esquerda ou direita, com conteúdo ao lado.
-   **Card Horizontal:** Mais largo do que alto, frequentemente usado em [[Glossário/Elementos/listas|listas]].
-   **Card Compacto:** Menor, com menos informação, para [[Glossário/Elementos/listas|listas]] densas.
