...
-   **Links de Navegação Secundária ou Utilitária:**
    ...
    *   FAQ / Ajuda
-   **Links para Redes Sociais:** [[Glossário/Linguagem Visual/iconografia|Ícones]] ou links textuais para os perfis da empresa em redes sociais.
...
-   **"Voltar ao Topo" ([[Glossário/Componentes/back_to_top|Back to Top]] Link - pode estar próximo ou integrado ao footer).**
