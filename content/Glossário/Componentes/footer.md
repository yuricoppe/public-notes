...
O Footer (Rodapé) é uma seção de conteúdo localizada na parte inferior de uma página web ou tela de aplicativo. Geralmente contém informações secundárias, [[Elementos/links|links]] de navegação, direitos autorais e outros elementos que não são o foco principal do conteúdo da página, mas são importantes para a completude e usabilidade do site.
...
-   **[[Elementos/links|Links]] de Navegação Secundária ou Utilitária:**
    *   Termos de Serviço
    *   Política de Privacidade
    *   Política de Cookies
    *   [[Entregáveis/site_map|Mapa do Site]]
    *   Contato / Fale Conosco
    *   Sobre Nós / Quem Somos
    *   Carreiras / Trabalhe Conosco
    *   FAQ / Ajuda
-   **[[Elementos/links|Links]] para Redes Sociais:** [[Linguagem Visual/iconografia|Ícones]] ou [[Elementos/links|links]] textuais para os perfis da empresa em redes sociais.
...
-   **"Voltar ao Topo" ([[Componentes/back_to_top|Back to Top]] [[Elementos/links|Link]] - pode estar próximo ou integrado ao footer).**

## Melhores Práticas

-   **Consistência:** O footer deve ser consistente em todas as páginas do site em termos de design e conteúdo principal.
-   **Organização:** Agrupar [[Elementos/links|links]] e informações de forma lógica (ex: colunas com títulos como "Empresa", "Recursos", "Legal").
-   **Legibilidade:** Usar [[Linguagem Visual/tipografia|tipografia]] clara e contraste suficiente, mesmo que o tamanho da fonte seja menor que o do corpo principal.
-   **Não Sobrecarregar:** Evitar encher o footer com excesso de [[Elementos/links|links]] ou informações desnecessárias. Priorizar o que é mais útil para o usuário.
...
-   **Acessibilidade (a11y):**
    ...
    *   Garantir que todos os [[Elementos/links|links]] sejam acessíveis por teclado e tenham texto descritivo.
    *   Manter uma estrutura de [[Elementos/cabecalhos|cabeçalhos]] lógica se houver títulos dentro do footer.
-   **Hierarquia Visual:** Mesmo sendo secundário, deve haver uma hierarquia clara dentro do próprio footer.

## Variações de Layout

-   **Footer Simples:** Apenas copyright e alguns [[Elementos/links|links]] essenciais.
-   **Footer com Múltiplas Colunas:** Para organizar um número maior de [[Elementos/links|links]].
-   **"Fat Footer":** Um footer mais extenso com bastante conteúdo e [[Elementos/links|links]], comum em sites grandes.
...
-   Footer desorganizado ou com excesso de [[Elementos/links|links]] que o torna difícil de usar.
-   [[Elementos/links|Links]] quebrados ou desatualizados.
