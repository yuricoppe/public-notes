...
-   **Feedback de Ação:** Informar se uma operação foi bem-sucedida (ex: "Item salvo com sucesso!") ou falhou (ex: "Erro ao enviar formulário.").
...
1.  **Alerts/Notificações Inline (Inline Alerts/Notifications):**
    ...
    *   Podem ser persistentes até que o usuário as dispense (se houver um botão de fechar) ou a condição mude.
    *   Comumente usadas para feedback de formulários, erros de validação, ou informações contextuais.
    *   Cores semânticas (sucesso, erro, aviso, informação) são frequentemente usadas.
...
5.  **Badges/Indicadores com Contagem (em Notificações):**
    *   Pequenos indicadores em ícones de sino ou e-mail mostrando o número de novas notificações não lidas.
