...
-   **Marcadores (Markers/Pins):** [[Glossário/Linguagem Visual/iconografia|Ícones]] que indicam pontos de interesse específicos no mapa.
...
-   **Controles de Mapa:** (ex: seletor de tipo de mapa - ruas/satélite, controle de zoom explícito, [[Glossário/Elementos/botoes|botão]] "Minha Localização").
