...
O componente Code Block é usado para exibir trechos de [[Glossário/Elementos/codigo|código]] de programação de forma legível e estruturada, geralmente com destaque de sintaxe (syntax highlighting) e funcionalidades adicionais como copiar o código.
...
-   **[[Glossário/Elementos/botoes|Botão]] "Copiar Código":** Permitir que o usuário copie facilmente todo o conteúdo do bloco de código para a área de transferência.
-   **Rolagem (Scroll):** Se o código for extenso, permitir rolagem horizontal e/ou vertical dentro do bloco.

## Melhores Práticas

-   **Legibilidade:** Usar fontes monoespaçadas claras. Garantir bom contraste entre o texto do código e o fundo do bloco, e entre as diferentes [[Glossário/Linguagem Visual/cor|cores]] do syntax highlighting.
...
-   **Não usar [[Glossário/Elementos/imagem|imagens]] para código:** O código deve ser texto real para ser acessível, selecionável e indexável.
...
-   (Opcional) [[Glossário/Elementos/cabecalhos|Cabeçalho]] com nome da linguagem, nome do arquivo, botão de copiar.
