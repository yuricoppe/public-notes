...
-   **Opções de Consentimento (dependendo da granularidade e da lei):
    ...
    *   **Gerenciar Preferências/[[Glossário/Padrões/settings|Configurações]] (Manage Preferences/Settings):** Link ou botão que leva a uma interface mais detalhada onde o usuário pode escolher granularmente quais categorias de cookies aceitar (ex: Essenciais, Analíticos, Marketing, Personalização).
...
-   **Interface de Configurações Detalhadas:** Com [[Glossário/Elementos/interruptor|toggles]] para cada categoria de cookie e descrições.
