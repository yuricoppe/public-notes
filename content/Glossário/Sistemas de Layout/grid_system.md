...
- **Responsividade:** O grid é projetado para se adaptar fluidamente a diferentes breakpoints.
...
- Os gutters são os espaços *entre* as colunas. O conteúdo não deve vazar para dentro dos gutters, a menos que seja uma decisão de design intencional e justificada (ex: imagens que sangram).
...
- **Use o Grid para Espaçamento Horizontal:** O grid ajuda a manter o espaçamento horizontal consistente.
