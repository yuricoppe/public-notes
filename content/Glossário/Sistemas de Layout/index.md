...
- **[[Glossário/Sistemas de Layout/breakpoints|Breakpoints]] Responsivos:** Definição dos pontos de quebra (breakpoints) para adaptar o layout a diferentes tamanhos de tela (desktop, tablet, mobile) e as diretrizes para cada um.
- **[[Glossário/Linguagem Visual/espacamento|Espaçamento]] (Spacing System):** Uma escala de espaçamento definida (ex: baseada em múltiplos de 4px ou 8px) para controlar as margens, paddings e o espaço entre os elementos de forma consistente.
