...
## Descrição Geral
Este documento descreve padrões de layout para as seções estruturais mais comuns encontradas nas páginas do nosso portal, como cabeçalhos, rodapés, áreas de conteúdo principal e barras laterais. O objetivo é garantir consistência na disposição dessas macro-áreas em diferentes templates de página.
...
### 1. Cabeçalho (Header)
- **Propósito:** Fornecer identidade da marca (logo), navegação principal, busca e, possivelmente, links de conta/login.
...
- **Layout Típico:**
    ...
    - Busca e ícones de conta/carrinho à direita.
- **Responsividade:**
    - Em telas menores, a navegação principal pode ser substituída por um menu "hambúrguer".
    - Elementos podem ser reorganizados ou simplificados.
- **Componentes Comuns:** Logo, Links de Navegação, Campo de Busca, Botão de Menu Mobile, Ícones.
...
- **Responsividade:**
    ...
    - O espaçamento pode ser reduzido.
...
- **Propósito:** Exibir o conteúdo primário da página (artigo, lista de produtos, formulário, etc.).
- **Posicionamento:** Entre o cabeçalho e o rodapé. Pode estar ao lado de uma barra lateral.
- **Layout Típico:**
...
- **Responsividade:**
    ...
    - Imagens e mídias devem ser responsivas.

### 4. Barra Lateral (Sidebar)
- **Propósito:** Fornecer navegação contextual, filtros, informações relacionadas, anúncios ou ações secundárias.
...
- **Componentes Comuns:** Menus de Navegação Secundária, Listas de Filtros, Cards de Informação, CTAs Secundários.
