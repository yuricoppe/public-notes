...
- **Revisão do Carrinho/Pedido:** Lista detalhada dos itens, quantidades, preços unitários e subtotais.
...
- **Campo para Código Promocional/Cupom.**
- **Botão de Ação Primário:** (ex: "Finalizar Compra", "Pagar Agora").
- **Links para Políticas:** (Política de Devolução, Termos de Serviço, Privacidade).
...
3. O usuário preenche os formulários necessários.
...
- Não exija registro obrigatório para comprar, se puder evitar.
