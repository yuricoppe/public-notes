...
## Descrição Geral
"Deslizar para Atualizar" (Swipe to Refresh) é um padrão de interação comum em aplicativos móveis e algumas aplicações web progressivas (PWAs), onde o usuário pode puxar uma lista ou tela para baixo com o dedo (ou mouse em alguns contextos desktop) para recarregar o conteúdo exibido. É uma forma intuitiva e gestual de solicitar dados mais recentes.
...
- **Performance Percebida:** Oferecer uma maneira rápida de obter conteúdo fresco sem navegação explícita para um botão de atualizar.
...
- **Indicador Visual de "Puxar" (Pull Indicator):** Geralmente um ícone (como uma seta para baixo ou um spinner parcial) que aparece no topo da área de conteúdo quando o usuário começa a puxar para baixo.
...
## Variações Comuns
- **Indicadores Visuais Personalizados:** A aparência do indicador de puxar e do spinner pode variar de acordo com o design system da aplicação.
