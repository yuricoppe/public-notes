...
- **Indicador de Carregamento ([[Glossário/Componentes/loading_spinner|Loading Spinner]]/Indicator):** Um [[Glossário/Componentes/loading_spinner|spinner]] ou animação que aparece quando o limite de "puxar" é atingido e a atualização de dados é iniciada. Substitui o indicador de "puxar".
...
1. O usuário está visualizando uma [[Glossário/Elementos/listas|lista]] ou tela com conteúdo que pode ser atualizado (ex: feed de notícias, caixa de entrada de emails).
...
3.  - **Gesto Curto/Rolagem Normal:** Se o gesto de puxar for curto e não atingir um limite predefinido, a interface pode interpretar como rolagem para o topo ou nenhuma ação específica de atualização.
    - **Gesto de Puxar para Atualizar:** Se o usuário puxar para baixo além de um certo limite:
        ...
        - Ao soltar o dedo (ou ao atingir um estado "pronto para atualizar"), o indicador visual muda para um [[Glossário/Componentes/loading_spinner|spinner]] de carregamento.
4. O sistema inicia a busca por novo conteúdo em segundo plano.
5.  - **Sucesso com Novo Conteúdo:** O novo conteúdo é carregado e exibido, geralmente no topo da [[Glossário/Elementos/listas|lista]], e o [[Glossário/Componentes/loading_spinner|spinner]] desaparece.
    - **Sucesso sem Novo Conteúdo:** O [[Glossário/Componentes/loading_spinner|spinner]] desaparece, e o conteúdo existente permanece (pode haver uma mensagem sutil como "Conteúdo atualizado").
    - **Falha:** O [[Glossário/Componentes/loading_spinner|spinner]] desaparece, e uma mensagem de erro pode ser exibida (ex: "Não foi possível atualizar. Verifique sua conexão.").
...
- Use em [[Glossário/Elementos/listas|listas]] ou seções de conteúdo que são atualizadas com frequência e onde os usuários esperam ver os dados mais recentes (ex: feeds sociais, emails, resultados esportivos).
...
- Não o torne a única forma de atualizar o conteúdo; considere também um [[Glossário/Elementos/botoes|botão]] de atualizar explícito para acessibilidade e descoberta, especialmente em contextos não-mobile.
...
- **Foco do Teclado:** Se um [[Glossário/Elementos/botoes|botão]] de atualização for a alternativa, ele deve ser focável e operável via teclado.
...
- Atualizar uma [[Glossário/Elementos/listas|lista]] de tarefas compartilhadas.

## Variações Comuns

- **Indicadores Visuais Personalizados:** A aparência do indicador de puxar e do [[Glossário/Componentes/loading_spinner|spinner]] pode variar de acordo com o [[Glossário/Entregáveis/design_system|design system]] da aplicação.
- **Integração com "Pull to Refresh, Push for More":** Algumas [[Glossário/Elementos/listas|listas]] podem combinar "puxar para baixo para atualizar" com "empurrar para cima no final da [[Glossário/Elementos/listas|lista]] para carregar mais itens (paginação)".
...
- [[[Glossário/Elementos/links|Link]] para animações ou [[Glossário/Entregáveis/prototype|protótipos]] demonstrando o comportamento do Swipe to Refresh no Figma]
