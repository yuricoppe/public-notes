...
- [[Elementos/form_controls|Checkbox]] para aceitação de Termos de Serviço e Política de Privacidade.
- [[Elementos/botoes|Botão]] de ação primário para submeter (ex: "Criar Conta", "Registrar").
- [[Elementos/links|Links]] para [[Padrões/authentication|login]] (caso o usuário já tenha uma conta) ou para políticas.
...
2. O sistema apresenta o [[Padrões/form_structure|formulário]] de registro.
...
6. O usuário submete o [[Padrões/form_structure|formulário]].
...
8.  - **Sucesso:**
        ...
        - Opcionalmente, o usuário pode ser logado automaticamente e/ou redirecionado para um tour de [[Padrões/launch|onboarding]] ou para o [[Entregáveis/dashboard|dashboard]].
        - Opcionalmente, pode ser necessária uma etapa de verificação de email/telefone.
    - **Falha:** O sistema exibe [[Componentes/messaging|mensagens]] de erro claras, indicando quais campos precisam ser corrigidos (ex: email já em uso, senha não atende aos critérios).
...
- Informe sobre o uso dos dados coletados ([[Elementos/links|link]] para Política de Privacidade).
- Otimize o processo para dispositivos móveis.

### Não Faça
- Não crie [[Padrões/form_structure|formulários]] de registro excessivamente longos e complexos.
- Não peça informações sensíveis desnecessariamente.
- Não use CAPTCHAs que sejam difíceis de resolver ou inacessíveis.
- Não esconda os [[Elementos/links|links]] para Termos de Serviço e Política de Privacidade.
- Não defina senhas fracas como padrão ou permita senhas óbvias sem aviso.

## Considerações de Acessibilidade
- Todos os campos de [[Padrões/form_structure|formulário]] devem ter rótulos (`<label for>`) claros e associados.
- As [[Componentes/messaging|mensagens]] de erro e sucesso devem ser acessíveis a leitores de tela e visualmente distintas.
...
- Mantenha contraste de [[Linguagem Visual/cor|cores]] adequado.
- Evite depender apenas de indicações visuais ([[Linguagem Visual/cor|cor]]) para feedback; use também texto ou [[Linguagem Visual/iconografia|ícones]].
...
- **Registro por Convite:** Acesso ao [[Padrões/form_structure|formulário]] de registro apenas através de um [[Elementos/links|link]] de convite.

## Status
A definir

## Recursos Adicionais / Figma
- [[[Elementos/links|Link]] para o design de telas de Criação de Conta no Figma]
- [[[Elementos/links|Link]] para os Termos de Serviço e Política de Privacidade padrão] 