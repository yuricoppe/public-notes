---
title: "hta diagram"
description: "Um Hierarchical Task Analysis (HTA) Diagram (Diagrama de Análise Hierárquica de Tarefas) é uma representação estruturada que decompõe uma tarefa complexa ou objetivo do usuário…"
tags:
  - tema/ux
  - tipo/glossario
---
...
Um diagrama HTA geralmente tem uma estrutura de árvore ou um formato de [[Glossário/Elementos/listas|lista]] aninhada:
...
*   **Sub-tarefas (Sub-tasks/Operations):** O objetivo principal é decomposto em várias sub-tarefas. Cada sub-tarefa pode, por sua vez, ser decomposta em sub-tarefas ainda menores.
    *   Ex: Para "Comprar um livro online":
        ...
        3.  Realizar o [[Glossário/Padrões/purchase_checkout|checkout]]
        4.  Confirmar pedido
