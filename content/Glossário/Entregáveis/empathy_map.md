...
Um **Empathy Map (Mapa de Empatia)** é uma ferramenta de visualização colaborativa usada para articular o que se sabe sobre um tipo particular de usuário ou persona. Ele ajuda as equipes a desenvolverem uma compreensão mais profunda e compartilhada das experiências, pensamentos, sentimentos, dores e ganhos de um usuário, promovendo a empatia.
...
1.  **DIZ (SAYS):**
    ...
    *   Ex: "Eu não consigo encontrar o botão de busca." "Isso é muito confuso."
...
*   **GANHOS (GAINS):**
    *   O que o usuário espera ou deseja alcançar? Quais são seus objetivos, necessidades e métricas de sucesso?
...
*   Artigo Relacionado (sobre tipos de mapas de empatia): [When to Use Empathy Maps: 3 Options](https://www.nngroup.com/articles/when-use-empathy-maps/)
