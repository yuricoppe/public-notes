...
Em UX, os Mapas Conceituais são usados para:
...
6.  **Refinar e Iterar:** Revise o mapa para clareza, precisão e completude. Adicione, remova ou reorganize conceitos e links conforme necessário. Busque por relações cruzadas (cross-links) entre diferentes seções do mapa.
...
| Característica        | Mapa Conceitual                                     | Mapa Mental                                          |
| :-------------------- | :-------------------------------------------------- | :--------------------------------------------------- |
...
*   Veja também: [Cognitive Map](./cognitive_map.md), [Mind Map](./mind_map.md) (Nota: Links serão atualizados ou verificados conforme os documentos são criados).
