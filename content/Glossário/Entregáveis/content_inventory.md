...
3.  **Identificar os Atributos a Serem Coletados:** Decidir quais informações serão registradas para cada item de conteúdo. Alguns atributos comuns incluem:
    ...
    *   [[Glossário/Linguagem Visual/metricas_e_keylines|Métricas]] básicas de analytics (ex: visualizações de página nos últimos X meses) - opcional, mas útil para a auditoria.
4.  **Coletar os Dados:**
