...
- Cards e listas para representar itens.
...
- **Formatos de Arquivo:**
  - `JPEG/JPG`: Para fotografias e imagens com muitas cores/gradações. Oferece boa compressão com perda.
  - `PNG`: Para imagens com transparência, logotipos, ícones complexos ou quando a fidelidade de cor é crucial. Compressão sem perda.
  ...
  - `SVG`: Para logotipos, ícones e ilustrações vetoriais. Escalável sem perda de qualidade.
...
- **Imagem Padrão (Inline/Block):**
  ...
  - Status: A definir
  - Link para o Figma: [Link para estilo de Imagem Padrão no Figma]
...
- **Imagem de Largura Total (Full Bleed):**
  ...
  - Status: A definir
  - Link para o Figma: [Link para Imagem Full Bleed no Figma]
...
- **Imagem com Posições (Inline with Positions - Float):**
  ...
  - Status: A definir
  - Link para o Figma: [Link para Imagem com Float no Figma]
...
- **Avatar:**
  ...
  - Status: A definir
  - Link para o Figma: [Link para componente Avatar no Figma]
...
## Link para o Figma (Visão Geral de Imagens)

[Link para a seção de Imagens e diretrizes de mídia no Figma] 