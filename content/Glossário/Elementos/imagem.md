...
- [[Componentes/cards|Cards]] e [[Elementos/listas|listas]] para representar itens.
...
- **Formatos de Arquivo:**
  - `JPEG/JPG`: Para fotografias e imagens com muitas [[Linguagem Visual/cor|cores]]/gradações. Oferece boa compressão com perda.
  - `PNG`: Para imagens com transparência, logotipos, [[Linguagem Visual/iconografia|ícones]] complexos ou quando a fidelidade de [[Linguagem Visual/cor|cor]] é crucial. Compressão sem perda.
  ...
  - `SVG`: Para logotipos, [[Linguagem Visual/iconografia|ícones]] e ilustrações vetoriais. Escalável sem perda de qualidade.
...
- **Imagem Padrão (Inline/Block):**
  ...
  - Status: A definir
  - [[Elementos/links|Link]] para o Figma: [[[Elementos/links|Link]] para estilo de Imagem Padrão no Figma]
...
- **Imagem de Largura Total (Full Bleed):**
  ...
  - Status: A definir
  - [[Elementos/links|Link]] para o Figma: [[[Elementos/links|Link]] para Imagem Full Bleed no Figma]
...
- **Imagem com Posições (Inline with Positions - Float):**
  ...
  - Status: A definir
  - [[Elementos/links|Link]] para o Figma: [[[Elementos/links|Link]] para Imagem com Float no Figma]
...
- **Avatar:**
  ...
  - Status: A definir
  - [[Elementos/links|Link]] para o Figma: [[[Elementos/links|Link]] para componente Avatar no Figma]
...
## [[Elementos/links|Link]] para o Figma (Visão Geral de Imagens)

[[[Elementos/links|Link]] para a seção de Imagens e diretrizes de mídia no Figma] 