...
- **[[Glossário/Linguagem Visual/cor|Cores]]:** A paleta de cores primárias, secundárias, de destaque, de feedback (sucesso, erro, aviso), e tons de cinza. Inclui os valores hexadecimais e variáveis CSS/Sass, se aplicável.
...
- **[[Glossário/Linguagem Visual/iconografia|Ícones]]:** A biblioteca de ícones utilizada no portal, suas especificações de tamanho, estilo (ex: outline, solid) e como utilizá-los (ex: SVG, font icon).
- **[[Glossário/Linguagem Visual/espacamento|Espaçamento]] (Base):** A unidade base de espaçamento e como ela é aplicada para criar consistência (complementar ao `layout_systems/spacing.md` que define a escala).
