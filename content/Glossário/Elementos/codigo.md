...
Utilizado para exibir trechos de código inline (dentro de um parágrafo) ou em blocos de código maiores (para exemplos mais extensos), comum em documentações técnicas e tutoriais.
...
- Tipografia monoespaçada para melhor legibilidade do código.
- Opção de copiar código para a área de transferência.
